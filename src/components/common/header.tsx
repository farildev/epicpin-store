...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed z-30 lg:w-[1080px] mx-auto bg-light dark:bg-dark lg:rounded-full border border-gray-200/50 dark:border-gray-100/5 lg:top-5 top-0 left-0 right-0 w-full">
